                        ...
                        <form @submit.prevent="actualizar" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <Input type="date" v-model="form.inicio_lectura" class="w-full border-gray-200 focus:ring-blue-500 rounded-xl" />
                                </div>

                                <div class="space-y-2">
                                    <Label class="text-gray-700 font-bold ml-1">Fin de la lectura</Label>
                                    <Input type="date" v-model="form.final_lectura" class="w-full border-gray-200 focus:ring-blue-500 rounded-xl" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <Input type="number" v-model="form.tiempo_lectura" class="w-full border-gray-200 rounded-xl" />
                                </div>

                                <div class="space-y-2">
                                    <Label class="text-gray-700 font-bold ml-1">Estado</Label>
                                    <select v-model="form.estado" class="w-full border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input type="number" min="0" max="5" v-model="form.puntuacion" class="w-full border-gray-200 rounded-xl" />
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Escribe aquí tus impresiones sobre el libro..."
                                ></textarea>
                            </div>
